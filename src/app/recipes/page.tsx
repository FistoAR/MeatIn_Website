  ...
  wing: [
    {
      ...
      servings: '3 Servings',
      diff: 'Easy',
      about: 'Crispy chicken wings deep-fried to golden perfection and tossed in a bold chili spice blend. Great as an appetizer or party snack.',
      tips: [
    ...
    },
    {
      ...
      servings: '4 Servings',
      diff: 'Easy',
      about: 'Oven-baked or grilled chicken wings coated in a rich honey barbecue glaze with smoked paprika notes.',
      tips: [
    ...
    },
    {
      ...
      servings: '4 Servings',
      diff: 'Easy',
      about: 'Irresistible chicken wings tossed in melted garlic herb butter and generously sprinkled with aged parmesan cheese.',
      tips: [
    ...
    },
    {
      ...
      servings: '4 Servings',
      diff: 'Easy',
      about: 'Fiery hot wings coated in authentic buffalo hot sauce and butter, served alongside celery sticks and ranch.',
      tips: [
  ...
  heart: [
    {
      ...
      servings: '3 Servings',
      diff: 'Easy',
      about: 'Juicy chicken hearts marinated in dark soy, garlic, and coarse black pepper, threaded on wooden skewers and grilled.',
      tips: [
    ...
    },
    {
      ...
      servings: '4 Servings',
      diff: 'Easy',
      about: 'A South Indian delicacy featuring tender chicken hearts sautéed with caramelized onions and freshly ground pepper.',
      tips: [
    ...
    },
    {
      ...
      servings: '4 Servings',
      diff: 'Medium',
      about: 'Tender chicken hearts simmered in a spiced coconut gravy infused with fennel, cloves, and coriander.',
      tips: [
    ...
    },
    {
      ...
      servings: '2 Servings',
      diff: 'Easy',
      about: 'Quick high-protein stir-fry of sliced chicken hearts with bell peppers and butter garlic sauce.',
      tips: [
  ...
  drumette: [
    {
      ...
      servings: '4 Servings',
      diff: 'Easy',
      about: 'Meaty chicken drumettes marinated in spiced buttermilk and fried to golden crunchy perfection.',
      tips: [
    ...
    },
    {
      ...
      servings: '4 Servings',
      diff: 'Easy',
      about: 'Oven-roasted chicken drumettes slathered in smoky BBQ glaze with caramelized edges.',
      tips: [
    ...
    },
    {
      ...
      servings: '4 Servings',
      diff: 'Medium',
      about: 'Fun lollipop-cut drumettes coated in Indo-Chinese Schezwan sauce, crispy outside and juicy inside.',
      tips: [
    ...
    },
    {
      ...
      servings: '3 Servings',
      diff: 'Easy',
      about: 'A healthy and elegant oven roast featuring drumettes rubbed with extra virgin olive oil, fresh rosemary, and garlic.',
      tips: [
  ...
  thigh: [
    {
      ...
      servings: '4 Servings',
      diff: 'Easy',
      about: 'Juicy bone-in chicken thighs simmered in a spiced onion gravy finished with fresh cream and kasuri methi.',
      tips: [
    ...
    },
    {
      ...
      servings: '4 Servings',
      diff: 'Easy',
      about: 'Marinated chicken thighs grilled over flame for smoky charred crust and moist, succulent meat inside.',
      tips: [
    ...
    },
    {
      ...
      servings: '3 Servings',
      diff: 'Easy',
      about: 'Boneless chicken thigh steaks coated in seasoned flour batter and fried crispy, ideal for sandwiches or burger patties.',
      tips: [
    ...
    },
    {
      ...
      servings: '4 Servings',
      diff: 'Medium',
      about: 'Kerala-style slow-roasted chicken thighs pan-cooked with caramelized shallots, curry leaves, and black pepper.',
      tips: [
  ...
  neck: [
    {
      ...
      servings: '4 Servings',
      diff: 'Easy',
      about: 'A wholesome wellness soup extracting rich marrow nutrients and collagen from clean chicken necks simmered with ginger and black pepper.',
      tips: [
    ...
    },
    {
      ...
      servings: '4 Servings',
      diff: 'Medium',
      about: 'Rich bone-in chicken necks cooked in a spicy Chettinad-style roasted pepper gravy.',
      tips: [
    ...
    },
    {
      ...
      servings: '6 Servings',
      diff: 'Easy',
      about: 'Pure homemade chicken bone broth made from collagen-dense necks, carrot, celery, and herbs.',
      tips: [
    ...
    },
    {
      ...
      servings: '3 Servings',
      diff: 'Easy',
      about: 'Crispy pan-fried chicken necks seasoned with spicy red chili, garlic, and fried curry leaves.',
      tips: [
  ...
  breast: [
    {
      ...
      servings: '2 Servings',
      diff: 'Easy',
      about: 'A lean, high-protein healthy dish of boneless chicken breast fillets marinated in lemon, garlic, and fresh herbs.',
      tips: [
    ...
    },
    {
      ...
      servings: '4 Servings',
      diff: 'Easy',
      about: 'Classic Butter Chicken featuring tender boneless breast cubes in a rich tomato, butter, and cashew cream sauce.',
      tips: [
    ...
    },
    {
      ...
      servings: '4 Servings',
      diff: 'Easy',
      about: 'Crispy homemade chicken nuggets made from tender breast bites, panko breadcrumbs, and Italian herbs.',
      tips: [
    ...
    },
    {
      ...
      servings: '2 Servings',
      diff: 'Easy',
      about: 'A refreshing fitness meal packed with lean grilled chicken breast, cucumbers, cherry tomatoes, and olive oil vinaigrette.',
      tips: [
  ...
  back: [
    {
      ...
      servings: '6 Servings',
      diff: 'Easy',
      about: 'Concentrated bone broth made from chicken backs rich in natural gelatin, ideal for gut health and immunity.',
      tips: [
    ...
    },
    {
      ...
      servings: '4 Servings',
      diff: 'Medium',
      about: 'Rustic country style chicken curry where chicken back pieces impart deep flavor into coconut curry.',
      tips: [
    ...
    },
    {
      ...
      servings: '5 Servings',
      diff: 'Easy',
      about: 'Clear savory chicken soup featuring tender chicken back pieces, sweet corn, and egg drops.',
      tips: [
    ...
    },
    {
      ...
      servings: '4 Servings',
      diff: 'Easy',
      about: 'Oven-roasted chicken back cuts tossed with aromatic Indian dry spices and crispy roasted onions.',
      tips: [
  ...
  liver: [
    {
      ...
      servings: '3 Servings',
      diff: 'Easy',
      about: 'A nutrient-dense iron-rich dish of fresh chicken liver sautéed with caramel onions, curry leaves, and black pepper.',
      tips: [
    ...
    },
    {
      ...
      servings: '4 Servings',
      diff: 'Easy',
      about: 'Soft chicken liver pieces simmered in a rich tomato onion masala gravy infused with cumin and coriander.',
      tips: [
    ...
    },
    {
      ...
      servings: '3 Servings',
      diff: 'Easy',
      about: 'Quick grilled skewers of fresh chicken liver basted in rich garlic butter and smoked paprika.',
      tips: [
    ...
    },
    {
      ...
      servings: '6 Servings',
      diff: 'Medium',
      about: 'Gourmet French-style chicken liver spread cooked with shallots, butter, and thyme, blended silky smooth.',
      tips: [
  ...
  drumstick: [
    {
      ...
      servings: '4 Servings',
      diff: 'Easy',
      about: 'Classic Indian tandoori drumsticks marinated in thick yogurt, Kashmiri chili, and tandoori spices, grilled to smoky charred perfection.',
      tips: [
    ...
    },
    {
      ...
      servings: '4 Servings',
      diff: 'Easy',
      about: 'Southern fried chicken drumsticks with extra crunchy flaked crust and juicy meat underneath.',
      tips: [
    ...
    },
    {
      ...
      servings: '4 Servings',
      diff: 'Medium',
      about: 'Authentic Tamil Nadu Chettinad chicken leg curry cooked with dry roasted spices, star anise, poppy seeds, and coconut.',
      tips: [
    ...
    },
    {
      ...
      servings: '4 Servings',
      diff: 'Easy',
      about: 'Tender oven-roasted drumsticks glazed with rich garlic, melted butter, parsley, and lemon.',
      tips: [
  ...
  gizzard: [
    {
      ...
      servings: '4 Servings',
      diff: 'Easy',
      about: 'A popular bar-style snack featuring boiled gizzards pan-roasted with curry leaves, green chillies, and coarse black pepper.',
      tips: [
    ...
    },
    {
      ...
      servings: '4 Servings',
      diff: 'Medium',
      about: 'Slow-braised gizzards cooked in a thick spicy onion-tomato gravy with fennel and garam masala.',
      tips: [
    ...
    },
    {
      ...
      servings: '3 Servings',
      diff: 'Easy',
      about: 'Street-style grilled gizzard skewers marinated in soy, chili, garlic, and sesame oil.',
      tips: [
    ...
    },
    {
      ...
      servings: '6 Servings',
      diff: 'Medium',
      about: 'Traditional Indian style meat pickle made with fried gizzards, mustard oil, vinegar, and pickling spices.',
      tips: [
...
export default function RecipesPage() {
  ...
  const [activeMeatType, setActiveMeatType] = useState<'chicken' | 'beef' | 'goat'>('chicken');
  ...
  return (
    <div className="relative min-h-screen bg-gray-50 antialiased flex flex-col selection:bg-[#87B71D] selection:text-white overflow-x-hidden pt-0">
      ...
      <section className="relative w-full bg-[#638913] text-white pt-24 sm:pt-32  px-[2vw] rounded-b-[40px] md:rounded-b-[20px] overflow-hidden select-none shadow-xl">

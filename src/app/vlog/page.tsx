...
export default function VlogComingSoonPage() {
  return (
    <div className="min-h-[85vh] bg-white text-slate-900 font-inter flex flex-col items-center justify-center pt-36 pb-20 px-4 relative overflow-hidden">
      ...
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[350px] h-[350px] bg-[#F7840F]/10 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="text-center max-w-2xl mx-auto space-y-6 relative z-10">
        ...
        <div className="flex items-center justify-center gap-2 mb-2">
          ...
          <span className="w-3 h-3 rounded-full bg-[#064823] shadow-sm animate-pulse delay-200" />
        </div>
        ...
        <h1 className="text-4xl sm:text-6xl font-extrabold text-slate-900 tracking-tight font-barlow-condensed uppercase leading-none">
          THIS PAGE IS{' '}
          <span className="text-[#F7840F] relative inline-block">
            COMING SOON
            <span className="absolute left-0 right-0 -bottom-1 h-1.5 bg-gradient-to-r from-[#F7840F] via-[#D4A437] to-[#064823] rounded-full" />
          </span>
        </h1>
        ...
        <div className="inline-flex items-center gap-6 pt-2 pb-4">
          <div className="flex items-center gap-2 text-xs font-bold text-[#F7840F]">
            <span className="w-2 h-2 rounded-full bg-[#F7840F]" /> Fresh Recipes
          </div>
          ...
          <div className="flex items-center gap-2 text-xs font-bold text-[#064823]">
            <span className="w-2 h-2 rounded-full bg-[#064823]" /> Farm Stories
          </div>
        </div>
        ...
        <div>
          <Link
            href="/"
            className="inline-flex items-center gap-2 bg-[#064823] hover:bg-[#0a5e30] text-white font-bold text-sm px-7 py-3.5 rounded-xl uppercase tracking-wider transition-all shadow-md hover:shadow-xl active:scale-95"
          >
